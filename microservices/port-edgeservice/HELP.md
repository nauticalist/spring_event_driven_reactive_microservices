...
* The original package name 'io.seanapse.course.microservices.port-edgeservice' is invalid and this project uses 'io.seanapse.course.microservices.portedgeservice' instead.
